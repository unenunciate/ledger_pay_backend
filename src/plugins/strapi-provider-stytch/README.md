<div align="center" style="margin: 0px 32px">
  <a width="300px" href="https://stytch.com/">
    <img style="width: 300px; height: auto;" src="public/assets/logo.png" alt="Logo - Strapi Provider Stytch" />
  </a>
</div>

<div align="center">
  <h1>Strapi v4 - Strapi - Stytch Authentication Provider</h1>
  <p>Utilizing stytch for a streemlined developer experiance when authenticating with almost any authenitciation method.</p>
  <a href="https://www.npmjs.org/package/strapi-provider-stytch">
    <img alt="GitHub package.json version" src="https://img.shields.io/github/package-json/v/unenunciate/strapi-provider-stytch?label=npm&logo=npm">
  </a>
  <a href="https://www.npmjs.org/package/strapi-provider-stytch">
    <img src="https://img.shields.io/npm/dm/strapi-plugin-stytch.svg" alt="Monthly download on NPM" />
  </a>
</div>
...
A plugin for [Strapi Headless CMS](https://github.com/strapi/strapi) that provides authentication via Stytch using any stytch configuration.
...
4. [🔧 Configuration](#-configuration)
   ...
   - [Plugin file](#d-efault-configuration-state)
...
As a ✅ **verified** plugin by Strapi team we're available on the [**Strapi Marketplace**](https://market.strapi.io/plugins/strapi-provider-stytch) as well as **In-App Marketplace** where you can follow the installation instructions.
